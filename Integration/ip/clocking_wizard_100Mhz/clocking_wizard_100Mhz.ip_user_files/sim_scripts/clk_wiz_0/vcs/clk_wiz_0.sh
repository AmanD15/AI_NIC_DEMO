...
#
# Generated by Vivado on Tue Apr 18 13:54:47 IST 2023
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../clocking_wizard_100Mhz.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../clocking_wizard_100Mhz.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/harshad/Project/git/AJIT_Ethernet/boards/ethernetVCU128/ip/clocking_wizard_100Mhz/clocking_wizard_100Mhz.cache/compile_simlib/vcs"
  fi
