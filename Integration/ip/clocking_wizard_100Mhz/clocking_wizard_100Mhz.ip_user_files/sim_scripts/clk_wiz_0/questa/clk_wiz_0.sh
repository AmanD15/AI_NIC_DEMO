...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/harshad/Project/git/AJIT_Ethernet/boards/ethernetVCU128/ip/clocking_wizard_100Mhz/clocking_wizard_100Mhz.cache/compile_simlib/questa"
  fi
