...
## set vio probes file
set_property PROBES.FILE {./system.ltx} [get_hw_devices xcvu37p_0]              
set_property FULL_PROBES.FILE {./system.ltx} [get_hw_devices xcvu37p_0]         

## set Program file
set_property PROGRAM.FILE {./system.bit} [get_hw_devices xcvu37p_0]    
#Program Device
