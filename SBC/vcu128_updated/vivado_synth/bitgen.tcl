...
#read_vhdl -library sbc_vcu128_core_lib ../toplevel/original_SBC/sbc_vcu128_core_edited.vhdl
...
read_vhdl -library sbc_vcu128_core_lib ../toplevel/SBC_FASTMEM/sbc_vcu128_core_edited.vhdl


############ ADDING TOP LEVEL VHDL #########################
# toplevel file for hsys (original SBC)
#read_vhdl ../toplevel/original_SBC/sbc_vcu128.vhdl


# toplevel file for hsys_1.1 (SBC with ACB SRAM)
read_vhdl ../toplevel/SBC_FASTMEM/sbc_vcu128.vhdl
...
############# CONSTRAINT FILE ###########
read_xdc ../constraints/vcu128.xdc
...
################### DRAM IPs ##################################################33
read_ip ../ip_consolidated/vcu128_networking_ip/ddr4_0/ddr4_0.xci
read_ip ../ip_consolidated/vcu128_networking_ip/fifo_generator_0/fifo_generator_0.xci
read_ip ../ip_consolidated/vcu128_networking_ip/fifo_generator_1/fifo_generator_1.xci
read_ip ../ip_consolidated/vcu128_networking_ip/fifo_generator_2/fifo_generator_2.xci
read_ip ../ip_consolidated/vcu128_networking_ip/fifo_generator_3/fifo_generator_3.xci
read_ip ../ip_consolidated/vcu128_networking_ip/fifo_generator_4/fifo_generator_4.xci
read_ip ../ip_consolidated/vcu128_networking_ip/fifo_generator_5/fifo_generator_5.xci

################### Networking IPs ##################################################33
#read_ip ../ip_consolidated/vcu128_networking_ip/tri_mode_ethernet_mac_0/tri_mode_ethernet_mac_0.xci
#read_ip ../ip_consolidated/vcu128_networking_ip/fifo_generator_0/fifo_generator_0.xci

read_ip ../ip_consolidated/vcu128_networking_ip/vio_80/vio_80.xci
read_ip ../ip_consolidated/vcu128_networking_ip/vio_125/vio_125.xci
read_ip ../ip_consolidated/vcu128_networking_ip/vio_200/vio_200.xci
read_ip ../ip_consolidated/vcu128_networking_ip/clk_wiz_0/clk_wiz_0.xci
read_ip ../ip_consolidated/vcu128_networking_ip/gig_ethernet_pcs_pma_0/gig_ethernet_pcs_pma_0.xci
read_ip ../ip_consolidated/vcu128_networking_ip/fifo_generator_acb_resp/fifo_generator_acb_resp.xci
read_ip ../ip_consolidated/vcu128_networking_ip/fifo_generator_acb_req/fifo_generator_acb_req.xci

# afb dual-clocked fifos are not used.
#read_ip ../ip_consolidated/vcu128_networking_ip/fifo_generator_afb_req/fifo_generator_afb_req.xci
#read_ip ../ip_consolidated/vcu128_networking_ip/fifo_generator_afb_resp/fifo_generator_afb_resp.xci

read_ip ../ip_consolidated/vcu128_networking_ip/ila_0/ila_0.xci
read_ip ../ip_consolidated/vcu128_networking_ip/ila_2/ila_2.xci
...
############### SYNTHESIZE ##############
synth_design -fsm_extraction off  -top sbc_vcu128 -part xcvu37p-fsvh2892-2L-e
...
write_bitstream -force processor_1x1x32.sbc.vcu128.bit
write_debug_probes -force processor_1x1x32.sbc.vcu128.ltx 
