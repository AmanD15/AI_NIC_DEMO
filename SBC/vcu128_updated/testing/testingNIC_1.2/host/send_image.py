...
class ImagePacketManager:
    ...
    def run(self):
        print(f"Sending image '{self.send_image}' as {self.total_packets} packets...")
...
if __name__ == "__main__":
    try:
        user_input = input("Enter send_image_file receive_image_file burst_size: ").strip()
        send_image, receive_image, burst_size = user_input.split()
