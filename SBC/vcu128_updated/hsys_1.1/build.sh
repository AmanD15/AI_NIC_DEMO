...
#
buildHierarchicalModel.py -M -u -H -s ghdl  -a  sbc_vcu128_core_sbc_vcu128_core_lib -J acb_sram/acb_sram.hsys -J ./GlueModules/GlueModules.hsys -I$AHIR_RELEASE/include $PARAMETERS $PIPES $SIGNALS
