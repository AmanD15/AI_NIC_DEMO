...
page_table_setup:
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=46, level=3,  ppnr=0x4002e000, p_addr=0xb8, cacheable=0x1, acc=0x4
   ! *(PAGE_TABLE_BASE + 0xb8) = 0x4002e92 (pte)
   set 0x4002e92, %g2
   set 0xb8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=51, level=3,  ppnr=0x40033000, p_addr=0xcc, cacheable=0x1, acc=0x4
   ! *(PAGE_TABLE_BASE + 0xcc) = 0x4003392 (pte)
   set 0x4003392, %g2
   set 0xcc, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
