...
compileToSparcUclibc.py \
  ...
  -D AJIT \
  -U \
  -D USE_VMAP -D USE_CORTOS -c $AJIT_HOME/AI_NIC_DEMO/SBC/kc705/testing/latestNICTesting/main.c -I $AJIT_HOME/AI_NIC_DEMO/SBC/kc705/testing/latestNICTesting/include -C $AJIT_HOME/AI_NIC_DEMO/SBC/kc705/testing/latestNICTesting/src;
