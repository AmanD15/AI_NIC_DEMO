...
page_table_setup:
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTD: context=0, index=80, level=1, child_p_addr=0x500, p_addr=0x940
   ! *(PAGE_TABLE_BASE + 0x940) = ptd(PAGE_TABLE_BASE + 0x500)
   ! make PTD from 0x500
   set 0x500, %g4
   add %g1, %g4, %g4
   srl %g4, 0x4, %g4
   ...
   st %g4, [%g3]
   ! g4 stored into [g3] 
   !PTD: context=0, index=0, level=2, child_p_addr=0x404, p_addr=0x500
   ...
   st %g4, [%g3]
   ! g4 stored into [g3] 
   !PTE: context=0, index=1, level=3,  ppnr=0x50001000, p_addr=0x404, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x404) = 0x5000116 (pte)
   set 0x5000116, %g2
   set 0x404, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=2, level=3,  ppnr=0x50002000, p_addr=0x408, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x408) = 0x5000216 (pte)
   set 0x5000216, %g2
   set 0x408, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=3, level=3,  ppnr=0x50003000, p_addr=0x40c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x40c) = 0x5000316 (pte)
   set 0x5000316, %g2
   set 0x40c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=4, level=3,  ppnr=0x50004000, p_addr=0x410, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x410) = 0x5000416 (pte)
   set 0x5000416, %g2
   set 0x410, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=5, level=3,  ppnr=0x50005000, p_addr=0x414, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x414) = 0x5000516 (pte)
   set 0x5000516, %g2
   set 0x414, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=6, level=3,  ppnr=0x50006000, p_addr=0x418, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x418) = 0x5000616 (pte)
   set 0x5000616, %g2
   set 0x418, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=7, level=3,  ppnr=0x50007000, p_addr=0x41c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x41c) = 0x5000716 (pte)
   set 0x5000716, %g2
   set 0x41c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=8, level=3,  ppnr=0x50008000, p_addr=0x420, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x420) = 0x5000816 (pte)
   set 0x5000816, %g2
   set 0x420, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=9, level=3,  ppnr=0x50009000, p_addr=0x424, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x424) = 0x5000916 (pte)
   set 0x5000916, %g2
   set 0x424, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=10, level=3,  ppnr=0x5000a000, p_addr=0x428, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x428) = 0x5000a16 (pte)
   set 0x5000a16, %g2
   set 0x428, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=11, level=3,  ppnr=0x5000b000, p_addr=0x42c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x42c) = 0x5000b16 (pte)
   set 0x5000b16, %g2
   set 0x42c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=12, level=3,  ppnr=0x5000c000, p_addr=0x430, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x430) = 0x5000c16 (pte)
   set 0x5000c16, %g2
   set 0x430, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=13, level=3,  ppnr=0x5000d000, p_addr=0x434, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x434) = 0x5000d16 (pte)
   set 0x5000d16, %g2
   set 0x434, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=14, level=3,  ppnr=0x5000e000, p_addr=0x438, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x438) = 0x5000e16 (pte)
   set 0x5000e16, %g2
   set 0x438, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=15, level=3,  ppnr=0x5000f000, p_addr=0x43c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x43c) = 0x5000f16 (pte)
   set 0x5000f16, %g2
   set 0x43c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=16, level=3,  ppnr=0x50010000, p_addr=0x440, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x440) = 0x5001016 (pte)
   set 0x5001016, %g2
   set 0x440, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=17, level=3,  ppnr=0x50011000, p_addr=0x444, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x444) = 0x5001116 (pte)
   set 0x5001116, %g2
   set 0x444, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=18, level=3,  ppnr=0x50012000, p_addr=0x448, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x448) = 0x5001216 (pte)
   set 0x5001216, %g2
   set 0x448, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=19, level=3,  ppnr=0x50013000, p_addr=0x44c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x44c) = 0x5001316 (pte)
   set 0x5001316, %g2
   set 0x44c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=20, level=3,  ppnr=0x50014000, p_addr=0x450, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x450) = 0x5001416 (pte)
   set 0x5001416, %g2
   set 0x450, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=21, level=3,  ppnr=0x50015000, p_addr=0x454, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x454) = 0x5001516 (pte)
   set 0x5001516, %g2
   set 0x454, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=22, level=3,  ppnr=0x50016000, p_addr=0x458, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x458) = 0x5001616 (pte)
   set 0x5001616, %g2
   set 0x458, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=23, level=3,  ppnr=0x50017000, p_addr=0x45c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x45c) = 0x5001716 (pte)
   set 0x5001716, %g2
   set 0x45c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=24, level=3,  ppnr=0x50018000, p_addr=0x460, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x460) = 0x5001816 (pte)
   set 0x5001816, %g2
   set 0x460, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=25, level=3,  ppnr=0x50019000, p_addr=0x464, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x464) = 0x5001916 (pte)
   set 0x5001916, %g2
   set 0x464, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=26, level=3,  ppnr=0x5001a000, p_addr=0x468, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x468) = 0x5001a16 (pte)
   set 0x5001a16, %g2
   set 0x468, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=27, level=3,  ppnr=0x5001b000, p_addr=0x46c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x46c) = 0x5001b16 (pte)
   set 0x5001b16, %g2
   set 0x46c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=28, level=3,  ppnr=0x5001c000, p_addr=0x470, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x470) = 0x5001c16 (pte)
   set 0x5001c16, %g2
   set 0x470, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=29, level=3,  ppnr=0x5001d000, p_addr=0x474, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x474) = 0x5001d16 (pte)
   set 0x5001d16, %g2
   set 0x474, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=30, level=3,  ppnr=0x5001e000, p_addr=0x478, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x478) = 0x5001e16 (pte)
   set 0x5001e16, %g2
   set 0x478, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=31, level=3,  ppnr=0x5001f000, p_addr=0x47c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x47c) = 0x5001f16 (pte)
   set 0x5001f16, %g2
   set 0x47c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=32, level=3,  ppnr=0x50020000, p_addr=0x480, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x480) = 0x5002016 (pte)
   set 0x5002016, %g2
   set 0x480, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=33, level=3,  ppnr=0x50021000, p_addr=0x484, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x484) = 0x5002116 (pte)
   set 0x5002116, %g2
   set 0x484, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=34, level=3,  ppnr=0x50022000, p_addr=0x488, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x488) = 0x5002216 (pte)
   set 0x5002216, %g2
   set 0x488, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=35, level=3,  ppnr=0x50023000, p_addr=0x48c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x48c) = 0x5002316 (pte)
   set 0x5002316, %g2
   set 0x48c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=36, level=3,  ppnr=0x50024000, p_addr=0x490, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x490) = 0x5002416 (pte)
   set 0x5002416, %g2
   set 0x490, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=37, level=3,  ppnr=0x50025000, p_addr=0x494, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x494) = 0x5002516 (pte)
   set 0x5002516, %g2
   set 0x494, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=38, level=3,  ppnr=0x50026000, p_addr=0x498, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x498) = 0x5002616 (pte)
   set 0x5002616, %g2
   set 0x498, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=39, level=3,  ppnr=0x50027000, p_addr=0x49c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x49c) = 0x5002716 (pte)
   set 0x5002716, %g2
   set 0x49c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=40, level=3,  ppnr=0x50028000, p_addr=0x4a0, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4a0) = 0x5002816 (pte)
   set 0x5002816, %g2
   set 0x4a0, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=41, level=3,  ppnr=0x50029000, p_addr=0x4a4, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4a4) = 0x5002916 (pte)
   set 0x5002916, %g2
   set 0x4a4, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=42, level=3,  ppnr=0x5002a000, p_addr=0x4a8, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4a8) = 0x5002a16 (pte)
   set 0x5002a16, %g2
   set 0x4a8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=43, level=3,  ppnr=0x5002b000, p_addr=0x4ac, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4ac) = 0x5002b16 (pte)
   set 0x5002b16, %g2
   set 0x4ac, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=44, level=3,  ppnr=0x5002c000, p_addr=0x4b0, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4b0) = 0x5002c16 (pte)
   set 0x5002c16, %g2
   set 0x4b0, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=45, level=3,  ppnr=0x5002d000, p_addr=0x4b4, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4b4) = 0x5002d16 (pte)
   set 0x5002d16, %g2
   set 0x4b4, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=46, level=3,  ppnr=0x5002e000, p_addr=0x4b8, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4b8) = 0x5002e16 (pte)
   set 0x5002e16, %g2
   set 0x4b8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=47, level=3,  ppnr=0x5002f000, p_addr=0x4bc, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4bc) = 0x5002f16 (pte)
   set 0x5002f16, %g2
   set 0x4bc, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=48, level=3,  ppnr=0x50030000, p_addr=0x4c0, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4c0) = 0x5003016 (pte)
   set 0x5003016, %g2
   set 0x4c0, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=49, level=3,  ppnr=0x50031000, p_addr=0x4c4, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4c4) = 0x5003116 (pte)
   set 0x5003116, %g2
   set 0x4c4, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=50, level=3,  ppnr=0x50032000, p_addr=0x4c8, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4c8) = 0x5003216 (pte)
   set 0x5003216, %g2
   set 0x4c8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=51, level=3,  ppnr=0x50033000, p_addr=0x4cc, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4cc) = 0x5003316 (pte)
   set 0x5003316, %g2
   set 0x4cc, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=52, level=3,  ppnr=0x50034000, p_addr=0x4d0, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4d0) = 0x5003416 (pte)
   set 0x5003416, %g2
   set 0x4d0, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=53, level=3,  ppnr=0x50035000, p_addr=0x4d4, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4d4) = 0x5003516 (pte)
   set 0x5003516, %g2
   set 0x4d4, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=54, level=3,  ppnr=0x50036000, p_addr=0x4d8, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4d8) = 0x5003616 (pte)
   set 0x5003616, %g2
   set 0x4d8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=55, level=3,  ppnr=0x50037000, p_addr=0x4dc, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4dc) = 0x5003716 (pte)
   set 0x5003716, %g2
   set 0x4dc, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=56, level=3,  ppnr=0x50038000, p_addr=0x4e0, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4e0) = 0x5003816 (pte)
   set 0x5003816, %g2
   set 0x4e0, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=57, level=3,  ppnr=0x50039000, p_addr=0x4e4, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4e4) = 0x5003916 (pte)
   set 0x5003916, %g2
   set 0x4e4, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=58, level=3,  ppnr=0x5003a000, p_addr=0x4e8, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4e8) = 0x5003a16 (pte)
   set 0x5003a16, %g2
   set 0x4e8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=59, level=3,  ppnr=0x5003b000, p_addr=0x4ec, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4ec) = 0x5003b16 (pte)
   set 0x5003b16, %g2
   set 0x4ec, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=60, level=3,  ppnr=0x5003c000, p_addr=0x4f0, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4f0) = 0x5003c16 (pte)
   set 0x5003c16, %g2
   set 0x4f0, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=61, level=3,  ppnr=0x5003d000, p_addr=0x4f4, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4f4) = 0x5003d16 (pte)
   set 0x5003d16, %g2
   set 0x4f4, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=62, level=3,  ppnr=0x5003e000, p_addr=0x4f8, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4f8) = 0x5003e16 (pte)
   set 0x5003e16, %g2
   set 0x4f8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=63, level=3,  ppnr=0x5003f000, p_addr=0x4fc, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4fc) = 0x5003f16 (pte)
   set 0x5003f16, %g2
   set 0x4fc, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=255, level=1,  ppnr=0xff000000, p_addr=0xbfc, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0xbfc) = 0xff00016 (pte)
   set 0xff00016, %g2
   set 0xbfc, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
