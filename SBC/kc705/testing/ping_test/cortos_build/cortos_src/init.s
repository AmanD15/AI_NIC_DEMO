...
.section .data
.align 8
  MEM_START_ADDR: .word 0x40000000
...
SETUP_THREAD_0_0:
  ...
  set 0x40031fa0, %sp  ! set stack address
  clr %fp
...
__cortos_init_region_to_zero:
  ...
  sethi %hi(0x40011000), %l0
  or %l0, %lo(0x40011000), %l0

  ! set the first illegal address
  sethi %hi(0x40012000), %l2
  or %l2, %lo(0x40012000), %l2
