...
page_table_setup:
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=19, level=3,  ppnr=0x40013000, p_addr=0x4c, cacheable=0x0, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x4c) = 0x400130e (pte)
   set 0x400130e, %g2
   set 0x4c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=50, level=3,  ppnr=0x40032000, p_addr=0xc8, cacheable=0x1, acc=0x4
   ! *(PAGE_TABLE_BASE + 0xc8) = 0x4003292 (pte)
   set 0x4003292, %g2
   set 0xc8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=32, level=1,  ppnr=0x20000000, p_addr=0x480, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x480) = 0x2000016 (pte)
   set 0x2000016, %g2
   set 0x480, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=33, level=1,  ppnr=0x21000000, p_addr=0x484, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x484) = 0x2100016 (pte)
   set 0x2100016, %g2
   set 0x484, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=34, level=1,  ppnr=0x22000000, p_addr=0x488, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x488) = 0x2200016 (pte)
   set 0x2200016, %g2
   set 0x488, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=35, level=1,  ppnr=0x23000000, p_addr=0x48c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x48c) = 0x2300016 (pte)
   set 0x2300016, %g2
   set 0x48c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=36, level=1,  ppnr=0x24000000, p_addr=0x490, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x490) = 0x2400016 (pte)
   set 0x2400016, %g2
   set 0x490, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=37, level=1,  ppnr=0x25000000, p_addr=0x494, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x494) = 0x2500016 (pte)
   set 0x2500016, %g2
   set 0x494, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=38, level=1,  ppnr=0x26000000, p_addr=0x498, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x498) = 0x2600016 (pte)
   set 0x2600016, %g2
   set 0x498, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=39, level=1,  ppnr=0x27000000, p_addr=0x49c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x49c) = 0x2700016 (pte)
   set 0x2700016, %g2
   set 0x49c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=40, level=1,  ppnr=0x28000000, p_addr=0x4a0, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4a0) = 0x2800016 (pte)
   set 0x2800016, %g2
   set 0x4a0, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=41, level=1,  ppnr=0x29000000, p_addr=0x4a4, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4a4) = 0x2900016 (pte)
   set 0x2900016, %g2
   set 0x4a4, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=42, level=1,  ppnr=0x2a000000, p_addr=0x4a8, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4a8) = 0x2a00016 (pte)
   set 0x2a00016, %g2
   set 0x4a8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=43, level=1,  ppnr=0x2b000000, p_addr=0x4ac, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4ac) = 0x2b00016 (pte)
   set 0x2b00016, %g2
   set 0x4ac, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=44, level=1,  ppnr=0x2c000000, p_addr=0x4b0, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4b0) = 0x2c00016 (pte)
   set 0x2c00016, %g2
   set 0x4b0, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=45, level=1,  ppnr=0x2d000000, p_addr=0x4b4, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4b4) = 0x2d00016 (pte)
   set 0x2d00016, %g2
   set 0x4b4, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=46, level=1,  ppnr=0x2e000000, p_addr=0x4b8, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4b8) = 0x2e00016 (pte)
   set 0x2e00016, %g2
   set 0x4b8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=47, level=1,  ppnr=0x2f000000, p_addr=0x4bc, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4bc) = 0x2f00016 (pte)
   set 0x2f00016, %g2
   set 0x4bc, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=48, level=1,  ppnr=0x30000000, p_addr=0x4c0, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4c0) = 0x3000016 (pte)
   set 0x3000016, %g2
   set 0x4c0, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=49, level=1,  ppnr=0x31000000, p_addr=0x4c4, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4c4) = 0x3100016 (pte)
   set 0x3100016, %g2
   set 0x4c4, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=50, level=1,  ppnr=0x32000000, p_addr=0x4c8, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4c8) = 0x3200016 (pte)
   set 0x3200016, %g2
   set 0x4c8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=51, level=1,  ppnr=0x33000000, p_addr=0x4cc, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4cc) = 0x3300016 (pte)
   set 0x3300016, %g2
   set 0x4cc, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=52, level=1,  ppnr=0x34000000, p_addr=0x4d0, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4d0) = 0x3400016 (pte)
   set 0x3400016, %g2
   set 0x4d0, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=53, level=1,  ppnr=0x35000000, p_addr=0x4d4, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4d4) = 0x3500016 (pte)
   set 0x3500016, %g2
   set 0x4d4, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=54, level=1,  ppnr=0x36000000, p_addr=0x4d8, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4d8) = 0x3600016 (pte)
   set 0x3600016, %g2
   set 0x4d8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=55, level=1,  ppnr=0x37000000, p_addr=0x4dc, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4dc) = 0x3700016 (pte)
   set 0x3700016, %g2
   set 0x4dc, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=56, level=1,  ppnr=0x38000000, p_addr=0x4e0, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4e0) = 0x3800016 (pte)
   set 0x3800016, %g2
   set 0x4e0, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=57, level=1,  ppnr=0x39000000, p_addr=0x4e4, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4e4) = 0x3900016 (pte)
   set 0x3900016, %g2
   set 0x4e4, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=58, level=1,  ppnr=0x3a000000, p_addr=0x4e8, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4e8) = 0x3a00016 (pte)
   set 0x3a00016, %g2
   set 0x4e8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=59, level=1,  ppnr=0x3b000000, p_addr=0x4ec, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4ec) = 0x3b00016 (pte)
   set 0x3b00016, %g2
   set 0x4ec, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=60, level=1,  ppnr=0x3c000000, p_addr=0x4f0, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4f0) = 0x3c00016 (pte)
   set 0x3c00016, %g2
   set 0x4f0, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=61, level=1,  ppnr=0x3d000000, p_addr=0x4f4, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4f4) = 0x3d00016 (pte)
   set 0x3d00016, %g2
   set 0x4f4, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=62, level=1,  ppnr=0x3e000000, p_addr=0x4f8, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4f8) = 0x3e00016 (pte)
   set 0x3e00016, %g2
   set 0x4f8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=63, level=1,  ppnr=0x3f000000, p_addr=0x4fc, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x4fc) = 0x3f00016 (pte)
   set 0x3f00016, %g2
   set 0x4fc, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
