...
############################################################
set_property IODELAY_GROUP tri_mode_ethernet_mac_iodelay_grp [get_cells  {tri_mode_ethernet_mac_0_example_design_inst/trimac_fifo_block/trimac_sup_block/tri_mode_ethernet_mac_idelayctrl_common_i}]
...
set_false_path -from [get_cells tri_mode_ethernet_mac_0_example_design_inst/pause_req* -filter IS_SEQUENTIAL]
set_false_path -from [get_cells tri_mode_ethernet_mac_0_example_design_inst/pause_val* -filter IS_SEQUENTIAL]


############################################################
# 5.5 Output Delay constraints
############################################################
...
set_false_path -from [get_cells -hier -filter {name =~ tri_mode_ethernet_mac_0_example_design_inst/tx_stats_reg[*]}] -to [get_cells -hier -filter {name =~ tri_mode_ethernet_mac_0_example_design_inst/tx_stats_shift_reg[*]}]
set_false_path -from [get_cells -hier -filter {name =~ tri_mode_ethernet_mac_0_example_design_inst/rx_stats_reg[*]}] -to [get_cells -hier -filter {name =~ tri_mode_ethernet_mac_0_example_design_inst/rx_stats_shift_reg[*]}]
...
set_max_delay -datapath_only -from [get_cells tri_mode_ethernet_mac_0_example_design_inst/tx_stats_toggle_reg] -to [get_cells tri_mode_ethernet_mac_0_example_design_inst/tx_stats_sync/data_sync_reg0] 6.000
set_max_delay -datapath_only -from [get_cells tri_mode_ethernet_mac_0_example_design_inst/rx_stats_toggle_reg] -to [get_cells tri_mode_ethernet_mac_0_example_design_inst/rx_stats_sync/data_sync_reg0] 6.000
