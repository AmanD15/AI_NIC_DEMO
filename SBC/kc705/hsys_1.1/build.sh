...
#
buildHierarchicalModel.py -M -u -H -s ghdl  -a  sbc_kc705_core_sbc_kc705_core_lib -J DualClockedFifos/DualClockedFifos.hsys -J acb_sram/acb_sram.hsys -J ./GlueModules/GlueModules.hsys -I$AHIR_RELEASE/include $PARAMETERS $PIPES $SIGNALS
