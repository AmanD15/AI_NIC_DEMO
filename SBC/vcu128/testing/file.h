...
void set_convolution_layer (uint16_t rb, uint16_t cb, uint16_t rt, uint16_t ct, uint16_t chl_out, uint16_t chl_in, uint16_t rk, uint16_t ck, uint32_t addr_in1, uint32_t addr_in2, uint32_t addr_k, uint32_t addr_out1, uint32_t addr_out2, uint32_t scale_val, uint16_t shift_val, uint16_t pad, uint8_t pool, uint8_t activation)
{
	cortos_printf("%u %u %u %u %u\n",addr_in1,addr_in2,addr_k,addr_out1,addr_out2);
...
void process_image(uint32_t** k_addr, uint32_t** t_addr)
{
	set_convolution_layer(224,224,224,224,64,3,3,3,(uint32_t)t_addr[0],ACC_UNUSED_ADDR,(uint32_t)k_addr[0],(uint32_t)t_addr[1],ACC_UNUSED_ADDR,1,0,1,0,relu);
	execute_layer();
	set_convolution_layer(224,224,224,224,64,64,3,3,(uint32_t)t_addr[1],ACC_UNUSED_ADDR,(uint32_t)k_addr[1],(uint32_t)t_addr[2],(uint32_t)t_addr[0],1,0,1,3,relu);
	execute_layer();
	set_convolution_layer(112,112,112,112,128,64,3,3,(uint32_t)t_addr[0],ACC_UNUSED_ADDR,(uint32_t)k_addr[2],(uint32_t)t_addr[1],ACC_UNUSED_ADDR,1,0,1,0,relu);
	execute_layer();
	set_convolution_layer(112,112,112,112,128,128,3,3,(uint32_t)t_addr[1],ACC_UNUSED_ADDR,(uint32_t)k_addr[3],(uint32_t)t_addr[3],(uint32_t)t_addr[0],1,0,1,3,relu);
	execute_layer();
	set_convolution_layer(56,56,56,56,256,128,3,3,(uint32_t)t_addr[0],ACC_UNUSED_ADDR,(uint32_t)k_addr[4],(uint32_t)t_addr[1],ACC_UNUSED_ADDR,1,0,1,0,relu);
	execute_layer();
	set_convolution_layer(56,56,56,56,256,256,3,3,(uint32_t)t_addr[1],ACC_UNUSED_ADDR,(uint32_t)k_addr[5],(uint32_t)t_addr[4],(uint32_t)t_addr[0],1,0,1,3,relu);
	execute_layer();
	set_convolution_layer(28,28,28,28,512,256,3,3,(uint32_t)t_addr[0],ACC_UNUSED_ADDR,(uint32_t)k_addr[6],(uint32_t)t_addr[1],ACC_UNUSED_ADDR,1,0,1,0,relu);
	execute_layer();
	set_convolution_layer(28,28,28,28,512,512,3,3,(uint32_t)t_addr[1],ACC_UNUSED_ADDR,(uint32_t)k_addr[7],(uint32_t)t_addr[0],ACC_UNUSED_ADDR,1,0,1,0,relu);
	execute_layer();
	set_convolution_layer(56,56,28,28,256,512,2,2,(uint32_t)t_addr[0],ACC_UNUSED_ADDR,(uint32_t)k_addr[8],(uint32_t)t_addr[1],ACC_UNUSED_ADDR,1,0,0,0,relu);
	execute_layer();
	set_convolution_layer(56,56,56,56,256,512,3,3,(uint32_t)t_addr[1],TWO_POWER_31+(uint32_t)t_addr[4],(uint32_t)k_addr[9],(uint32_t)t_addr[0],ACC_UNUSED_ADDR,1,0,1,0,relu);
	execute_layer();
	set_convolution_layer(56,56,56,56,256,256,3,3,(uint32_t)t_addr[0],ACC_UNUSED_ADDR,(uint32_t)k_addr[10],(uint32_t)t_addr[1],ACC_UNUSED_ADDR,1,0,1,0,relu);
	execute_layer();
	set_convolution_layer(112,112,56,56,128,256,2,2,(uint32_t)t_addr[1],ACC_UNUSED_ADDR,(uint32_t)k_addr[11],(uint32_t)t_addr[0],ACC_UNUSED_ADDR,1,0,0,0,relu);
	execute_layer();
	set_convolution_layer(112,112,112,112,128,256,3,3,(uint32_t)t_addr[0],TWO_POWER_31+(uint32_t)t_addr[3],(uint32_t)k_addr[12],(uint32_t)t_addr[1],ACC_UNUSED_ADDR,1,0,1,0,relu);
	execute_layer();
	set_convolution_layer(112,112,112,112,128,128,3,3,(uint32_t)t_addr[1],ACC_UNUSED_ADDR,(uint32_t)k_addr[13],(uint32_t)t_addr[0],ACC_UNUSED_ADDR,1,0,1,0,relu);
	execute_layer();
	set_convolution_layer(224,224,112,112,64,128,2,2,(uint32_t)t_addr[0],ACC_UNUSED_ADDR,(uint32_t)k_addr[14],(uint32_t)t_addr[1],ACC_UNUSED_ADDR,1,0,0,0,relu);
	execute_layer();
	set_convolution_layer(224,224,224,224,64,128,3,3,(uint32_t)t_addr[1],TWO_POWER_31+(uint32_t)t_addr[2],(uint32_t)k_addr[15],(uint32_t)t_addr[0],ACC_UNUSED_ADDR,1,0,1,0,relu);
	execute_layer();
	set_convolution_layer(224,224,224,224,64,64,3,3,(uint32_t)t_addr[0],ACC_UNUSED_ADDR,(uint32_t)k_addr[16],(uint32_t)t_addr[1],ACC_UNUSED_ADDR,1,0,1,0,relu);
	execute_layer();
	set_convolution_layer(224,224,224,224,3,64,3,3,(uint32_t)t_addr[1],ACC_UNUSED_ADDR,(uint32_t)k_addr[17],(uint32_t)t_addr[0],ACC_UNUSED_ADDR,1,0,1,0,sigmoid);
	execute_layer();
}
